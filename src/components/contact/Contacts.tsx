  ...
  return (
    <div className={`fixed bottom-0 w-full ${isDisplayed ? "translate-y-0": "translate-y-full"}`}>
        ...
        <div className={`bg-[#323B4C] w-full flex justify-between items-center border-y border-black py-2 px-8 `}>
          ...
          <a href='/public/quangan-cv.pdf' download='Bui Quang An - Web developer.pdf' className='bg-[#FFFBF5] inline-flex items-center justify-center rounded-lg w-[150px] text-[#323B4C] h-[50px]'>
            Download here
          </a>
        </div>
